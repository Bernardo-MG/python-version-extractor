...
# -*- coding: utf-8 -*-
#
# Version extractor documentation build configuration file.
...
with open('../../version_extractor/__init__.py', 'rb',
          encoding='utf-8') as f:
    version_lib = f.read()
...
sys.path.append(os.path.abspath('../../version_extractor'))
...
texinfo_documents = [
    (master_doc, project, '%s Documentation' % project,
     ','.join(authors), project, 'Extracts the version from a Python file',
     'Miscellaneous'),
]
